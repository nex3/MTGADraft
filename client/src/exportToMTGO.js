...
function exportCardToMTGO(c, language, full) {
...
export default function exportToMTGO(deck, sideboard, language, lands, sideboardBasics = 0, full = true) {
	let str = full ? "Deck\n" : "";
	for (let c of deck) str += exportCardToMTGO(c, language, full);
	if (lands) {
